...
port_1_var <- quantile(sim1[,n_days]- initial_wealth, prob=0.05)
```
...
port_2_var <- quantile(sim2[,n_days]- initial_wealth, prob=0.05)
```
...
port_3_var <- quantile(sim3[,n_days]- initial_wealth, prob=0.05)
```
